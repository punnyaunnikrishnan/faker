 ...
 */
 function Faker (opts) {
  ...
  self.refrigerator = new refrigerator(self);

  var motor_bike = require('./motor_bike');
  self.motor_bike = new motor_bike(self);
  ...
  var _definitions = {
    ...
    "refrigerator": ["refrigerator", "manufacturer", "model", "country_of_origin", "power_consumption"],
    "motor_bike": ["motor_bike", "manufacturer", "Models", "motor_type"],
    "title": "",
    "separator": ""
  };
